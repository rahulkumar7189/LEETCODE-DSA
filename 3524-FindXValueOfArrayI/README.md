...
- Remove the empty prefix and the suffix `[2, 3, 4, 5]`. `nums` becomes `[1]`. - Remove the prefix `[1, 2, 3]` and the suffix `[5]`. `nums` becomes `[4]`.
...
- Remove the empty prefix and the suffix `[4, 8, 16, 32]`. `nums` becomes `[1, 2]`. - Remove the empty prefix and the suffix `[2, 4, 8, 16, 32]`. `nums` becomes `[1]`. - Remove the prefix `[1]` and the suffix `[4, 8, 16, 32]`. `nums` becomes `[2]`.
